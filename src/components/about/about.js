...
const About = () => (
    <div id='style-scroll' className='about-scroll'>
        <div className='about__block'>
            ...
            <p className='about__p'>Занимаюсь созданием современных веб-страниц и&nbsp;веб-приложений с&nbsp;полной адаптивностью и&nbsp;полноценной интерактивностью под&nbsp;любые устройства как по&nbsp;дизайн-макету, так и&nbsp;без&nbsp;него.</p>
